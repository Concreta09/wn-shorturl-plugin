...
class ResolverTest extends ShortPluginTestCase
{
    /** @test */
    ...
    public function request_is_aborted_if_url_is_single_use_and_has_already_been_visited()
    {
        ...
        $shortURL = ShortURL::create([
            ...
            'default_short_url' => Config::get('concreta.shorturl::default_url').'/short/12345',
            'url_key'           => '12345',
            'single_use'        => true,
            'track_visits'      => true,
        ]);
        ...
        $request = Request::create(Config::get('concreta.shorturl::default_url').'/short/12345');
    ...
    public function visit_details_are_not_recorded_if_url_does_not_have_tracking_enabled()
    {
        ...
        $this->assertDatabaseHas('concreta_shorturl_short_url_visits', [
    ...
    public function only_specific_fields_are_recorded_if_enabled()
    {
        ...
        $request = Request::create(Config::get('concreta.shorturl::default_url').'/short/12345', 'GET', [], [], [], [
