...
use Concreta\ShortURL\Exceptions\ShortURLException;
...
use ShortURLBuilder as ShortURLAlias;

class BuilderTest extends ShortPluginTestCase
{
    public function setUp(): void
    {
        parent::setUp();

        Config::set('concreta.shorturl::default_url', 'https://short-url.com');
        Config::set('concreta.shorturl::prefix', '/short');
        Config::set('concreta.shorturl::key_length', 5);
    ...
    {
        Config::set('concreta.shorturl::enforce_https', true);
        $builder = new Builder();
    ...
    {
        Config::set('concreta.shorturl::enforce_https', false);
        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->make();
        $this->assertSame('http://domain.com', $shortUrl->destination_url);
    }
    ...
    {
        Config::set('concreta.shorturl::forward_query_params', true);

        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->make();
        $this->assertTrue($shortUrl->forward_query_params);

        Config::set('concreta.shorturl::forward_query_params', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.default_enabled', true);

        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->make();
        $this->assertTrue($shortUrl->track_visits);

        Config::set('concreta.shorturl::tracking.default_enabled', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.ip_address', true);

        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->trackIPAddress(false)->make();
        $this->assertFalse($shortUrl->track_ip_address);

        Config::set('concreta.shorturl::tracking.fields.ip_address', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.browser', true);

        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->trackBrowser(false)->make();
        $this->assertFalse($shortUrl->track_browser);

        Config::set('concreta.shorturl::tracking.fields.browser', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.browser_version', true);
        ...
        Config::set('concreta.shorturl::tracking.fields.browser_version', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.operating_system', true);
        ...
        Config::set('concreta.shorturl::tracking.fields.operating_system', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.operating_system_version', true);
        ...
        Config::set('concreta.shorturl::tracking.fields.operating_system_version', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.referer_url', true);

        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->trackRefererURL(false)->make();
        $this->assertFalse($shortUrl->track_referer_url);

        Config::set('concreta.shorturl::tracking.fields.referer_url', false);
    ...
    {
        Config::set('concreta.shorturl::tracking.fields.device_type', true);

        $builder = new Builder();
        $shortUrl = $builder->destinationUrl('http://domain.com')->trackDeviceType(false)->make();
        $this->assertFalse($shortUrl->track_device_type);

        Config::set('concreta.shorturl::tracking.fields.device_type', false);
    ...
    public function explicitly_defined_url_key_can_be_used_if_it_does_not_exist_in_the_db()
    {
        ...
        $this->assertDatabaseHas('concreta_shorturl_shorturls', ['url_key' => 'urlkey123']);
    }
    ...
    public function short_url_can_be_created_and_stored_in_the_database()
    {
        ...
        $this->assertDatabaseHas('concreta_shorturl_shorturls', [
    ...
    {
        Config::set('concreta.shorturl::prefix', '/s');
    ...
    {
        Config::set('concreta.shorturl::prefix', $prefix);

        self::assertSame($expected, ShortURLAlias::prefix());
    }

    /** @test */
    public function short_url_can_be_created_with_a_null_prefix_converted_to_default(): void
    {
        $deactivateTime = now()->addHours(2);

        Config::set('concreta.shorturl::prefix', null);
    ...
    {
        Config::set('concreta.shorturl::default_url', null);
    ...
    public function short_url_can_be_created_with_a_custom_integer_seed(): void
    {
        ...
        $this->assertSame('https://short-url.com/short/xlR2m', $shortUrlOne->default_short_url);
    }
